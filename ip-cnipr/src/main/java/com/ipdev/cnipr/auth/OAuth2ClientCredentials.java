...
public class OAuth2ClientCredentials {
    ...
    public static String PASSWORD = "kris526216107"; // TODO: for security purpose, we should use Odin to manage these
                                                     // credential
    ...
    public static Map<Domain, String> API_URL_MAP = Maps.newHashMap();

    static {
        API_URL_MAP.put(Domain.PROD, "https://open.cnipr.com/cnipr-api/rs/api/");
        API_URL_MAP.put(Domain.TEST, "https://59.151.93.239/cnipr-api/rs/api/");
    }

    public static String getApiURL(Domain domain) {
        return API_URL_MAP.get(domain);
    }
